...
function yes() {
    ...
    question.textContent = "Yessss! see you on the 14th"
    gif.src = 'giphy (4).webp'
...
var gifs = ['giphy (1).webp', '200w.webp', 'giphy (2).webp', '200 (2).webp', '200 (3).webp', 'giphy (3).webp']
var noCount = 0
